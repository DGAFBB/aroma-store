    ...
    return (
        <Container>
            <Col className="justify-content-md-center">
                ...
                <Nav style={{color:'#370601'}}>
                    <Link style={{color:'#370601', paddingTop:"2%"}} className="col-link" to={ORDER_ROUTE} activeClassName='active1'>Мои покупки</Link><p/>
                </Nav>
                <Nav style={{color:'#370601'}}>
                    <Link style={{color:'#370601', paddingTop:"2%"}} className="col-link" to={FAVOR_ROUTE} activeClassName='active1'>Избранное</Link><p/>
                </Nav>
            </Col>
        </Container>
    );
